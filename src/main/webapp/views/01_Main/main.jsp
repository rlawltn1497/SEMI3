...
<%@include file="/views/07_common/header.jsp"%>
    ...
    <!-- 헤더 큰 이미지 -->
    <section class="d-flex align-items-center dark-overlay bg-cover" style="background-image: url(<%= path%>/resources/img/img_semi/캠핑_화창_01.jpg); height: 650px; margin: 60px;">
        <!-- 헤더 이미지 글씨 -->
        ...
        <div class="container ">
            ...
            <div class="row ">
                <div class="d-flex align-items-lg-stretch mb-1 col-lg-8 " style="height: 450px; ">
                    <div class="card shadow-lg border-0 w-100 border-0 hover-animate " style="background: center center url(<%=path%>/resources/img/img_semi/camp03.jpg) no-repeat; background-size: cover; ">
    ...
    <section class="py-3 bg-gray-100 ">
        <div class="container ">
            <div class="row mb-5 ">
                <div class="col-md-8 fs-2 mb-3 " style="font-weight: bolder ; ">
                    <img src="<%= path%>/resources/img/img_semi/캠핑용품01.png" alt="Image " width="50px "> 캠핑용품
                </div>
                <div class="col-md-4 d-md-flex align-items-center justify-content-end ">
                    <a class="text-mutedCustom text-base " style="font-weight: bolder ; " href="category.html ">
            ...
            <div class="swiper-container swiper-container-mx-negative items-slider-full px-lg-5 pt-3 ">
                ...
                <div class="swiper-wrapper pb-5 ">
                    ...
                    <div class="swiper-slide h-auto px-2 ">
                        <div class="w-100 h-100 hover-animate " data-marker-id="59c0c8e33b1527bfe2abaf92 ">
                            <div class="card h-100 border-0 shadow ">
                                <div class="card-img-top overflow-hidden gradient-overlay "> <img class="img-fluid " src="<%= path%>/resources/img/img_semi/캠핑바구니.png " style="height:250px;">
                    ...
                    <div class="swiper-slide h-auto px-2 ">
                        <div class="w-100 h-100 hover-animate " data-marker-id="59c0c8e33b1527bfe2abaf92 ">
                            <div class="card h-100 border-0 shadow ">
                                <div class="card-img-top overflow-hidden gradient-overlay "> <img class="img-fluid " src="<%= path%>/resources/img/img_semi/텐트01.png " style="height:250px;">
                                    <a class=" tile-link " href="detail-rooms.html "></a>
                                    <div class="card-img-overlay-top text-end ">
                                        <a class="card-fav-icon position-relative z-index-40 " href="javascript: void(); ">
                                            <svg class="svg-icon text-white ">
                    ...
                    <div class="swiper-slide h-auto px-2 ">
                        <div class="w-100 h-100 hover-animate " data-marker-id="59c0c8e33b1527bfe2abaf92 ">
                            <div class="card h-100 border-0 shadow ">
                                <div class="card-img-top overflow-hidden gradient-overlay "> <img class="img-fluid " src="<%= path%>/resources/img/img_semi/텐트02.png " style="height:250px;">
                                    <a class="tile-link " href="detail-rooms.html "></a>
                                    <div class="card-img-overlay-top text-end ">
                                        <a class="card-fav-icon position-relative z-index-40 " href="javascript: void(); ">
                                            <svg class="svg-icon text-white ">
                    ...
                    <div class="swiper-slide h-auto px-2 ">
                        <div class="w-100 h-100 hover-animate " data-marker-id="59c0c8e33b1527bfe2abaf92 ">
                            <div class="card h-100 border-0 shadow ">
                                <div class="card-img-top overflow-hidden gradient-overlay "> <img class="img-fluid " src="<%= path%>/resources/img/img_semi/테이블.png" style="height:250px;">
                                    <a class="tile-link " href="detail-rooms.html "></a>
                                    <div class="card-img-overlay-top text-end ">
                                        <a class="card-fav-icon position-relative z-index-40 " href="javascript: void(); ">
                                            <svg class="svg-icon text-white ">
            ...
            <div class="row ">
                <div class="col-lg-6 me-lg-auto ">
                    <div class="col-md-6 fs-2 mb-3 " style="font-weight: bolder ; ">
                        ...
                        <path d="M13 2.5a1.5 1.5 0 0 1 3 0v11a1.5 1.5 0 0 1-3 0v-.214c-2.162-1.241-4.49-1.843-6.912-2.083l.405 2.712A1 1 0 0 1 5.51 15.1h-.548a1 1 0 0 1-.916-.599l-1.85-3.49a68.14 68.14 0 0 0-.202-.003A2.014 2.014 0 0 1 0 9V7a2.02 2.02
