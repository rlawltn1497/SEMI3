        ...
        <div class="container ">
            <div class="row my-3">
                <div class="col-md-3" style="font-size: 20px; font-weight:bolder ; text-align: center;">
                    <img class=" avatar avatar-sm   " src="/resources/img/img_semi/campfire01.png" alt=""> 캠핑사나이
                </div>
                <div class="col-md-9 ">
                    <form action="#">
                        <div class="row pe-6">
    ...
    <section class="pt-0 pb-3 p-print-0">
        <div class="container ">
            ...
            <div class="row my-3 pb-4">
                <div class="col-md-3" style="font-size: 20px; font-weight:bolder ; text-align: center;">
                    <img class=" avatar avatar-sm   " src="/resources/img/img_semi/campfire01.png" alt=""> 자연 여행자
                </div>
                <div class="col-md-9 ">
                    <form action="#">
                        <div class="row pe-6">
