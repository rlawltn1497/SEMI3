...
<body style="padding-top: 72px;">
    ...
    <!-- 헤더 큰 이미지 -->
    <section class="d-flex align-items-center dark-overlay bg-cover " style="background-image: url(/resources/img/img_semi/문의01_01.png); height: 350px; margin: 60px;">
        <!-- 헤더 이미지 글씨 -->
        <div class="container">
        </div>
    </section>
    ...
    <section class="py-10">
        <div class="container">
            <div class="col-lg-12 mb-3  mb-lg-8">
                <div class="col-md-12">
                    <div class=" fs-1 mb-3" style="text-align: center; font-weight:bolder; color: #F05945;"><img src="/resources/img/img_semi/community01.png" width="60px"> 자유 게시판 </div>
    ...
    <div class="container">
        <div class=" mb-lg-1 ">
            <button class="btn btn-primary rounded-top" type="button" style="font-size: 16px;" onclick="location.href = 'freeBoard03.html' ">
              <img src="/resources/img/img_semi/글등록01_03.png" width="35px">글 작성
            </button>
        </div>
    </div>
    <!-- 게시글 부분 -->
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center col-md-2">
                                    <img class="d-inline-block avatar avatar-xxm   align-text-top" src="/resources/img/img_semi/campfire01.png" alt=""> 캠핑러버
                                </td>
