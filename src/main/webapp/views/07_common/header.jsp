...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath() %>/resources/vendor/nouislider/nouislider.css">
        ...
        <nav class="navbar navbar-expand-lg fixed-top shadow navbar-light bg-white ">
            <div class="container-fluid ms-n8 ">
                <div class="d-flex align-items-end">
                    <a class="navbar-brand py-1" href="main.html"><img src="${pageContext.request.contextPath}/resources/img/img_semi/모닥불로고05.png" width="200px"></a>
                    <!-- 로고 옆 검색창 -->
                    <nav class="navbar bg-white">
                        <div class="container-fluid">
                            <form class="d-flex" role="search" action="<%=path%>/campingItem/totalSearch" method="get">
                                ...
                                <input class="form-control me-2 ms-xl-0" type="search" value="" placeholder="     캠핑용품 검색" aria-label="Search">
                            </form>
                        </div>
                    </nav>
                </div>
                ...
                <div class="d-inline-flex align-items-end position-static mt-n12 me-n8">
                    <div class="collapse navbar-collapse " id="navbarCollapse">
                        <ul class="navbar-nav ms-auto ">
                            <li class="nav-item"><a class="nav-link me-4" href="${pageContext.request.contextPath}/views/01_Main/main.jsp" style="font-size:25px; color: rgb(28, 27, 27); "> HOME </a>
                            </li>
                            <li class="nav-item"><a class="nav-link me-4" href="{pageContext.request.contextPath}/camping/list" style="font-size:25px;color: rgb(28, 27, 27)">캠핑장</a>
                            </li>
                            <li class="nav-item"><a class="nav-link me-4" href="{pageContext.request.contextPath}/views/03_Item/campingItem.jsp" style="font-size:25px;color: rgb(28, 27, 27)">캠핑용품</a>
                            </li>
                            <li class="nav-item"><a class="nav-link me-4" href="freeBoard01.html" style="font-size:25px; color: rgb(28, 27, 27);"> 자유게시판 </a>
                            </li>
                            <li class="nav-item"><a class="nav-link me-4" href="{pageContext.request.contextPath}/member/mypage" style="font-size:25px;color: rgb(28, 27, 27)">마이페이지</a>
                            </li>
                            <%if(loginMember == null){ %>
                            ...
                            <li class="nav-item dropdown position-static mt-8 ">
                                <a class="nav-link " href="#" data-bs-toggle="dropdown"><img src="{pageContext.request.contextPath}/resources/img/img_semi/목록01.png" style="width: 50px;"></a>
