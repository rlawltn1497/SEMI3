...
public class ReviewVO {
    ...
    public ReviewVO(int rev_no, String rev_title, String rev_content, Date rev_regist, String rev_image, String rev_star,
			int user_no, int cs_no) {
		super();
		this.rev_no = rev_no;
	...
	public String toString() {
		return "Review [rev_no=" + rev_no + ", rev_title=" + rev_title + ", rev_content=" + rev_content
				+ ", rev_regist=" + rev_regist + ", rev_image=" + rev_image + ", rev_star=" + rev_star + ", user_no="
				+ user_no + ", cs_no=" + cs_no + "]";
	}
